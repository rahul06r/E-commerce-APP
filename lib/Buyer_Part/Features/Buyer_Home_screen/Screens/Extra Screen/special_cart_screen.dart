...
class SpeacialCartScreenPage extends ConsumerStatefulWidget {
  const SpeacialCartScreenPage({super.key});

  @override
  ConsumerState<ConsumerStatefulWidget> createState() =>
      _SpeacialCartScreenPageState();
}

class _SpeacialCartScreenPageState
    extends ConsumerState<SpeacialCartScreenPage> {
